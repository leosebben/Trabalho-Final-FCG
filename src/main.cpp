...
// Headers da biblioteca para carregar modelos obj. Fonte: laboratirio 4
...
struct SceneObject
{
    ...
    GLuint       vertex_array_object_id; // ID do VAO onde estão armazenados os atributos do modelo. Fonte laboratorio 04
};
...
// Constrói triângulos para futura renderização a partir de um ObjModel. Fonte: laboratorio 4
